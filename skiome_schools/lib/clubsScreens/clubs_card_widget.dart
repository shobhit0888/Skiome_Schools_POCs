...
class ClubsCardWidget extends StatefulWidget {
  @override
  State<ClubsCardWidget> createState() => _CompetitionsCardWidgetState();
}

class _CompetitionsCardWidgetState extends State<ClubsCardWidget> {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (c) => ClubsScreen()));
      },
      child: Card(
        elevation: 15,
